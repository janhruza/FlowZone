...
public partial class App : Application
{
    ...
    public static void CriticalError(string message, string? tag)
    {
        ...
        // show error info
        if (MessageBox.Show($"Critical error has occurred. Message: {message} Do you want to terminate the process and report this error to Microsoft?", tag ?? "Critical Error", MessageBoxButton.YesNo, MessageBoxImage.Error) == MessageBoxResult.Yes)
        {
